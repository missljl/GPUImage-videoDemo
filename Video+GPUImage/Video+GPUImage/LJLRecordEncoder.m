...
@end
@implementation LJLRecordEncoder
- (void)dealloc {
    _writer = nil;
    _videoInput = nil;
    _audioInput = nil;
 ...
 */
+ (LJLRecordEncoder *)encoderForPath:(NSString *)path
                             height:(NSInteger)height
                              width:(NSInteger)width
                           channels:(int)ch
                            samples:(Float64)rate {
    LJLRecordEncoder *recordEncoder = [[LJLRecordEncoder alloc] initPath:path height:height width:width channels:ch samples:rate];
