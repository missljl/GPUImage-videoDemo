...
//    [(GPUImagePinchDistortionFilter*)Filter21 setScale:0.5];
    ...
    [arr addObject:dic25];
      ...
      GPUImageBeautifyFilter *Filter26 = [[GPUImageBeautifyFilter alloc] init];
    
    NSString *title26 = @"美颜";
    NSDictionary *dic26 = [NSDictionary dictionaryWithObjectsAndKeys:Filter26,@"filter",title26,@"name",nil];
    [arr addObject:dic26];
